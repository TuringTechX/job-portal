...
export const getJobPost = (_id) => (dispatch) => {
  dispatch(setLoading());
  axios
    .get(`https://job-portal-hzd0.onrender.com/api/job/${id}`, {
      headers: {
...
export const getAllJobPost = () => (dispatch) => {
  dispatch(setLoading());
  axios
    .get("https://job-portal-hzd0.onrender.com/api/job/get-all-job", {
      headers: {
        "x-auth-token": `${localStorage.getItem("job-token")}`,
      },
    })
...
export const postJob = (body) => (dispatch) => {
  dispatch(setLoading());
  axios
    .post("https://job-portal-hzd0.onrender.com/api/job/post-job", body, {
      headers: {
        "Content-Type": "application/json",
        "x-auth-token": `${localStorage.getItem("job-token")}`,
      },
...
export const updateJobPost = (post) => (dispatch) => {
  dispatch(setLoading());
  axios
    .patch(`https://job-portal-hzd0.onrender.com/api/job/update-job/${post._id}`, post, {
      headers: {
        "Content-Type": "application/json",
        "x-auth-token": `${localStorage.getItem("job-token")}`,
      },
...
export const deleteJobPost = (_id) => (dispatch) => {
  if (confirm("Are you sure you want to delete?")) {
    dispatch(setLoading());
    axios
      .delete(`https://job-portal-hzd0.onrender.com/api/job/delete-job/${_id}`, {
        headers: {
          "x-auth-token": `${localStorage.getItem("job-token")}`,
        },
      })
